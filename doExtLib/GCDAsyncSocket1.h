...
@class GCDAsyncReadPacket1;
@class GCDAsyncWritePacket1;
@class GCDAsyncSocketPreBuffer1;
@protocol GCDAsyncSocketDelegate1;

NS_ASSUME_NONNULL_BEGIN

extern NSString *const GCDAsyncSocketException1;
extern NSString *const GCDAsyncSocketErrorDomain1;

extern NSString *const GCDAsyncSocketQueueName1;
extern NSString *const GCDAsyncSocketThreadName1;

extern NSString *const GCDAsyncSocketManuallyEvaluateTrust1;
#if TARGET_OS_IPHONE
extern NSString *const GCDAsyncSocketUseCFStreamForTLS1;
#endif
#define GCDAsyncSocketSSLPeerName1     (NSString *)kCFStreamSSLPeerName
#define GCDAsyncSocketSSLCertificates1 (NSString *)kCFStreamSSLCertificates
#define GCDAsyncSocketSSLIsServer1     (NSString *)kCFStreamSSLIsServer
extern NSString *const GCDAsyncSocketSSLPeerID1;
extern NSString *const GCDAsyncSocketSSLProtocolVersionMin1;
extern NSString *const GCDAsyncSocketSSLProtocolVersionMax1;
extern NSString *const GCDAsyncSocketSSLSessionOptionFalseStart1;
extern NSString *const GCDAsyncSocketSSLSessionOptionSendOneByteRecord1;
extern NSString *const GCDAsyncSocketSSLCipherSuites1;
#if !TARGET_OS_IPHONE
extern NSString *const GCDAsyncSocketSSLDiffieHellmanParameters1;
#endif

#define GCDAsyncSocketLoggingContext1 65535


typedef NS_ENUM(NSInteger, GCDAsyncSocketError1) {
...
@interface GCDAsyncSocket1 : NSObject
...
- (instancetype)initWithDelegate:(nullable id<GCDAsyncSocketDelegate1>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq;
- (instancetype)initWithDelegate:(nullable id<GCDAsyncSocketDelegate1>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq;

#pragma mark Configuration

@property (atomic, weak, readwrite, nullable) id<GCDAsyncSocketDelegate1> delegate;
...
- (void)getDelegate:(id<GCDAsyncSocketDelegate1> __nullable * __nullable)delegatePtr delegateQueue:(dispatch_queue_t __nullable * __nullable)delegateQueuePtr;
- (void)setDelegate:(nullable id<GCDAsyncSocketDelegate1>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
...
**/
- (void)synchronouslySetDelegate:(nullable id<GCDAsyncSocketDelegate1>)delegate;
- (void)synchronouslySetDelegateQueue:(nullable dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(nullable id<GCDAsyncSocketDelegate1>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
 ...
 * 
 * - GCDAsyncSocketManuallyEvaluateTrust1
 ...
 *
 * - GCDAsyncSocketUseCFStreamForTLS1 (iOS only)
 *     The value must be of type NSNumber, encapsulating a BOOL value.
 ...
 *
 * - GCDAsyncSocketSSLProtocolVersionMin1
 * - GCDAsyncSocketSSLProtocolVersionMax1
 ...
 *
 * - GCDAsyncSocketSSLDiffieHellmanParameters1 (Mac OS X only)
 *     The value must be of type NSData.
 ...
 *     You MUST use manual trust evaluation instead (see GCDAsyncSocketManuallyEvaluateTrust1).
 ...
 *     You MUST use GCDAsyncSocketSSLProtocolVersionMin1 & GCDAsyncSocketSSLProtocolVersionMin1 instead.
...
@protocol GCDAsyncSocketDelegate1 <NSObject>
@optional
...
**/
- (nullable dispatch_queue_t)newSocketQueueForConnectionFromAddress:(NSData *)address onSocket:(GCDAsyncSocket1 *)sock;
...
**/
- (void)socket:(GCDAsyncSocket1 *)sock didConnectToHost:(NSString *)host port:(uint16_t)port;

/**
 * Called when a socket connects and is ready for reading and writing.
 * The host parameter will be an IP address, not a DNS name.
 **/
- (void)socket:(GCDAsyncSocket1 *)sock didConnectToUrl:(NSURL *)url;
...
**/
- (void)socket:(GCDAsyncSocket1 *)sock didReadPartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
 ...
 * It may be used to for things such as updating progress bars.
**/
- (void)socket:(GCDAsyncSocket1 *)sock didWritePartialDataOfLength:(NSUInteger)partialLength tag:(long)tag;
...
**/
- (NSTimeInterval)socket:(GCDAsyncSocket1 *)sock shouldTimeoutReadWithTag:(long)tag
...
**/
- (NSTimeInterval)socket:(GCDAsyncSocket1 *)sock shouldTimeoutWriteWithTag:(long)tag
                                                                  elapsed:(NSTimeInterval)elapsed
                                                                bytesDone:(NSUInteger)length;
...
**/
- (void)socketDidCloseReadStream:(GCDAsyncSocket1 *)sock;
...
**/
- (void)socketDidDisconnect:(GCDAsyncSocket1 *)sock withError:(nullable NSError *)err;
...
**/
- (void)socket:(GCDAsyncSocket1 *)sock didReceiveTrust:(SecTrustRef)trust
