...
#define LogAsync   YES
#define LogContext GCDAsyncSocketLoggingContext1
...
NSString *const GCDAsyncSocketException1 = @"GCDAsyncSocketException1";
NSString *const GCDAsyncSocketErrorDomain1 = @"GCDAsyncSocketErrorDomain1";

NSString *const GCDAsyncSocketQueueName1 = @"GCDAsyncSocket1";
NSString *const GCDAsyncSocketThreadName1 = @"GCDAsyncSocket1-CFStream";

NSString *const GCDAsyncSocketManuallyEvaluateTrust1 = @"GCDAsyncSocketManuallyEvaluateTrust1";
#if TARGET_OS_IPHONE
NSString *const GCDAsyncSocketUseCFStreamForTLS1 = @"GCDAsyncSocketUseCFStreamForTLS1";
#endif
NSString *const GCDAsyncSocketSSLPeerID1 = @"GCDAsyncSocketSSLPeerID1";
NSString *const GCDAsyncSocketSSLProtocolVersionMin1 = @"GCDAsyncSocketSSLProtocolVersionMin1";
NSString *const GCDAsyncSocketSSLProtocolVersionMax1 = @"GCDAsyncSocketSSLProtocolVersionMax1";
NSString *const GCDAsyncSocketSSLSessionOptionFalseStart1 = @"GCDAsyncSocketSSLSessionOptionFalseStart1";
NSString *const GCDAsyncSocketSSLSessionOptionSendOneByteRecord1 = @"GCDAsyncSocketSSLSessionOptionSendOneByteRecord1";
NSString *const GCDAsyncSocketSSLCipherSuites1 = @"GCDAsyncSocketSSLCipherSuites1";
#if !TARGET_OS_IPHONE
NSString *const GCDAsyncSocketSSLDiffieHellmanParameters1 = @"GCDAsyncSocketSSLDiffieHellmanParameters1";
#endif
...
@interface GCDAsyncSocketPreBuffer1 : NSObject
{
	uint8_t *preBuffer;
...
@implementation GCDAsyncSocketPreBuffer1
...
/**
 * The GCDAsyncReadPacket1 encompasses the instructions for any given read.
 * The content of a read packet allows the code to determine if we're:
 *  - reading to a certain length
 *  - reading to a certain separator
 *  - or simply reading the first chunk of available data
**/
@interface GCDAsyncReadPacket1 : NSObject
{
  @public
...
- (NSUInteger)readLengthForTermWithPreBuffer:(GCDAsyncSocketPreBuffer1 *)preBuffer found:(BOOL *)foundPtr;

- (NSInteger)searchForTermAfterPreBuffering:(ssize_t)numBytes;

@end

@implementation GCDAsyncReadPacket1
...
/**
 * The GCDAsyncWritePacket1 encompasses the instructions for any given write.
**/
@interface GCDAsyncWritePacket1 : NSObject
{
  @public
	NSData *buffer;
	NSUInteger bytesDone;
...
@implementation GCDAsyncWritePacket1
...
**/
@interface GCDAsyncSpecialPacket1 : NSObject
{
  @public
...
@implementation GCDAsyncSpecialPacket1
...
@implementation GCDAsyncSocket1
{
	uint32_t flags;
	uint16_t config;
	
	__weak id<GCDAsyncSocketDelegate1> delegate;
	...
	GCDAsyncReadPacket1 *currentRead;
	GCDAsyncWritePacket1 *currentWrite;
	
	unsigned long socketFDBytesAvailable;
	
	GCDAsyncSocketPreBuffer1 *preBuffer;
	...
	GCDAsyncSocketPreBuffer1 *sslPreBuffer;
...
- (id)initWithDelegate:(id<GCDAsyncSocketDelegate1>)aDelegate delegateQueue:(dispatch_queue_t)dq socketQueue:(dispatch_queue_t)sq
{
	if((self = [super init]))
	{
		delegate = aDelegate;
		...
		{
			socketQueue = dispatch_queue_create([GCDAsyncSocketQueueName1 UTF8String], NULL);
		}
		...
		preBuffer = [[GCDAsyncSocketPreBuffer1 alloc] initWithCapacity:(1024 * 4)];
...
- (void)getDelegate:(id<GCDAsyncSocketDelegate1> *)delegatePtr delegateQueue:(dispatch_queue_t *)delegateQueuePtr
{
	if (dispatch_get_specific(IsOnSocketQueueOrTargetQueueKey))
	{
...
- (BOOL)acceptOnInterface:(NSString *)inInterface port:(uint16_t)port error:(NSError **)errPtr
{
	...
	dispatch_block_t block = ^{ @autoreleasepool {
		...
		if (enableIPv4)
		{
			...
			__weak GCDAsyncSocket1 *weakSelf = self;
			
			dispatch_source_set_event_handler(accept4Source, ^{ @autoreleasepool {
			#pragma clang diagnostic push
			#pragma clang diagnostic warning "-Wimplicit-retain-self"
				
				__strong GCDAsyncSocket1 *strongSelf = weakSelf;
...
- (BOOL)doAccept:(int)parentSocketFD
{
	...
	if (delegateQueue)
	{
		...
		dispatch_async(delegateQueue, ^{ @autoreleasepool {
			...
			GCDAsyncSocket1 *acceptedSocket = [[[self class] alloc] initWithDelegate:theDelegate
...
- (NSError *)badConfigError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:GCDAsyncSocketErrorDomain1 code:GCDAsyncSocketBadConfigError userInfo:userInfo];
}
...
- (NSError *)badParamError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:GCDAsyncSocketErrorDomain1 code:GCDAsyncSocketBadParamError userInfo:userInfo];
}
...
- (NSError *)connectTimeoutError
{
	...
	return [NSError errorWithDomain:GCDAsyncSocketErrorDomain1 code:GCDAsyncSocketConnectTimeoutError userInfo:userInfo];
}
...
- (NSError *)readMaxedOutError
{
	...
	return [NSError errorWithDomain:GCDAsyncSocketErrorDomain1 code:GCDAsyncSocketReadMaxedOutError userInfo:info];
}
...
- (NSError *)readTimeoutError
{
	...
	return [NSError errorWithDomain:GCDAsyncSocketErrorDomain1 code:GCDAsyncSocketReadTimeoutError userInfo:userInfo];
}
...
- (NSError *)writeTimeoutError
{
	...
	return [NSError errorWithDomain:GCDAsyncSocketErrorDomain1 code:GCDAsyncSocketWriteTimeoutError userInfo:userInfo];
}
...
- (NSError *)connectionClosedError
{
	...
	return [NSError errorWithDomain:GCDAsyncSocketErrorDomain1 code:GCDAsyncSocketClosedError userInfo:userInfo];
}
...
- (NSError *)otherError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:GCDAsyncSocketErrorDomain1 code:GCDAsyncSocketOtherError userInfo:userInfo];
}
...
- (BOOL)usingCFStreamForTLS
{
	...
	{
		// The startTLS method was given the GCDAsyncSocketUseCFStreamForTLS1 flag.
                        ...
                        tag:(long)tag
{
	...
	GCDAsyncReadPacket1 *packet = [[GCDAsyncReadPacket1 alloc] initWithData:buffer
	                                                          startOffset:offset
	                                                            maxLength:length
	                                                              timeout:timeout
	                                                           readLength:0
...
- (float)progressOfReadReturningTag:(long *)tagPtr bytesDone:(NSUInteger *)donePtr total:(NSUInteger *)totalPtr
{
	...
	dispatch_block_t block = ^{
		...
		if (!currentRead || ![currentRead isKindOfClass:[GCDAsyncReadPacket1 class]])
		{
...
- (void)maybeDequeueRead
{
	...
	if ((currentRead == nil) && (flags & kConnected))
	{
		if ([readQueue count] > 0)
		{
			...
			if ([currentRead isKindOfClass:[GCDAsyncSpecialPacket1 class]])
			{
			...
			{
				LogVerbose(@"Dequeued GCDAsyncReadPacket1");
...
- (void)doReadData
{
	...
	if ([self usingCFStreamForTLS])
	{
		...
		// Requested CFStream, rather than SecureTransport, for TLS (via GCDAsyncSocketUseCFStreamForTLS1)
...
- (void)completeCurrentRead
{
	...
	{
		GCDAsyncReadPacket1 *theRead = currentRead; // Ensure currentRead retained since result may not own buffer
...
- (void)doReadTimeout
{
	...
	{
		GCDAsyncReadPacket1 *theRead = currentRead;
...
- (void)writeData:(NSData *)data withTimeout:(NSTimeInterval)timeout tag:(long)tag
{
	...
	GCDAsyncWritePacket1 *packet = [[GCDAsyncWritePacket1 alloc] initWithData:data timeout:timeout tag:tag];
...
- (float)progressOfWriteReturningTag:(long *)tagPtr bytesDone:(NSUInteger *)donePtr total:(NSUInteger *)totalPtr
{
	...
	dispatch_block_t block = ^{
		...
		if (!currentWrite || ![currentWrite isKindOfClass:[GCDAsyncWritePacket1 class]])
		{
...
- (void)maybeDequeueWrite
{
	...
	if ((currentWrite == nil) && (flags & kConnected))
	{
		if ([writeQueue count] > 0)
		{
			...
			if ([currentWrite isKindOfClass:[GCDAsyncSpecialPacket1 class]])
			{
				LogVerbose(@"Dequeued GCDAsyncSpecialPacket");
			...
			{
				LogVerbose(@"Dequeued GCDAsyncWritePacket1");
...
- (void)doWriteTimeout
{
	...
	{
		GCDAsyncWritePacket1 *theWrite = currentWrite;
...
- (void)startTLS:(NSDictionary *)tlsSettings
{
	...
	GCDAsyncSpecialPacket1 *packet = [[GCDAsyncSpecialPacket1 alloc] initWithTLSSettings:tlsSettings];
...
- (void)maybeStartTLS
{
	...
	if ((flags & kStartingReadTLS) && (flags & kStartingWriteTLS))
	{
		...
		#if TARGET_OS_IPHONE
		{
			GCDAsyncSpecialPacket1 *tlsPacket = (GCDAsyncSpecialPacket1 *)currentRead;
            NSDictionary *tlsSettings = @{};
            if (tlsPacket) {
                tlsSettings = tlsPacket->tlsSettings;
            }
			NSNumber *value = [tlsSettings objectForKey:GCDAsyncSocketUseCFStreamForTLS1];
...
{
	GCDAsyncSocket1 *asyncSocket = (__bridge GCDAsyncSocket1 *)connection;
...
- (void)ssl_startTLS
{
	...
	BOOL shouldManuallyEvaluateTrust = [[tlsSettings objectForKey:GCDAsyncSocketManuallyEvaluateTrust1] boolValue];
	...
	//  3. GCDAsyncSocketSSLPeerID1
	//  4. GCDAsyncSocketSSLProtocolVersionMin1
	//  5. GCDAsyncSocketSSLProtocolVersionMax1
	//  6. GCDAsyncSocketSSLSessionOptionFalseStart1
	//  7. GCDAsyncSocketSSLSessionOptionSendOneByteRecord1
	//  8. GCDAsyncSocketSSLCipherSuites1
	//  9. GCDAsyncSocketSSLDiffieHellmanParameters1 (Mac)
	//
	...
	value = [tlsSettings objectForKey:GCDAsyncSocketSSLPeerID1];
	...
	{
		NSAssert(NO, @"Invalid value for GCDAsyncSocketSSLPeerID1. Value must be of type NSData."
		             @" (You can convert strings to data using a method like"
		             @" [string dataUsingEncoding:NSUTF8StringEncoding])");
		
		[self closeWithError:[self otherError:@"Invalid value for GCDAsyncSocketSSLPeerID1."]];
		return;
	}
	
	// 4. GCDAsyncSocketSSLProtocolVersionMin1
	
	value = [tlsSettings objectForKey:GCDAsyncSocketSSLProtocolVersionMin1];
	...
	{
		NSAssert(NO, @"Invalid value for GCDAsyncSocketSSLProtocolVersionMin1. Value must be of type NSNumber.");
		
		[self closeWithError:[self otherError:@"Invalid value for GCDAsyncSocketSSLProtocolVersionMin1."]];
		return;
	}
	
	// 5. GCDAsyncSocketSSLProtocolVersionMax1
	
	value = [tlsSettings objectForKey:GCDAsyncSocketSSLProtocolVersionMax1];
	if ([value isKindOfClass:[NSNumber class]])
	{
	...
	{
		NSAssert(NO, @"Invalid value for GCDAsyncSocketSSLProtocolVersionMax1. Value must be of type NSNumber.");
		
		[self closeWithError:[self otherError:@"Invalid value for GCDAsyncSocketSSLProtocolVersionMax1."]];
		return;
	}
	
	// 6. GCDAsyncSocketSSLSessionOptionFalseStart1
	
	value = [tlsSettings objectForKey:GCDAsyncSocketSSLSessionOptionFalseStart1];
	if ([value isKindOfClass:[NSNumber class]])
	{
	...
	{
		NSAssert(NO, @"Invalid value for GCDAsyncSocketSSLSessionOptionFalseStart1. Value must be of type NSNumber.");
		
		[self closeWithError:[self otherError:@"Invalid value for GCDAsyncSocketSSLSessionOptionFalseStart1."]];
		return;
	}
	
	// 7. GCDAsyncSocketSSLSessionOptionSendOneByteRecord1
	
	value = [tlsSettings objectForKey:GCDAsyncSocketSSLSessionOptionSendOneByteRecord1];
	if ([value isKindOfClass:[NSNumber class]])
	{
	...
	{
		NSAssert(NO, @"Invalid value for GCDAsyncSocketSSLSessionOptionSendOneByteRecord1."
		             @" Value must be of type NSNumber.");
		
		[self closeWithError:[self otherError:@"Invalid value for GCDAsyncSocketSSLSessionOptionSendOneByteRecord1."]];
		return;
	}
	
	// 8. GCDAsyncSocketSSLCipherSuites1
	
	value = [tlsSettings objectForKey:GCDAsyncSocketSSLCipherSuites1];
	if ([value isKindOfClass:[NSArray class]])
	{
	...
	{
		NSAssert(NO, @"Invalid value for GCDAsyncSocketSSLCipherSuites1. Value must be of type NSArray.");
		
		[self closeWithError:[self otherError:@"Invalid value for GCDAsyncSocketSSLCipherSuites1."]];
		return;
	}
	
	// 9. GCDAsyncSocketSSLDiffieHellmanParameters1
	
	#if !TARGET_OS_IPHONE
	value = [tlsSettings objectForKey:GCDAsyncSocketSSLDiffieHellmanParameters1];
	if ([value isKindOfClass:[NSData class]])
	{
	...
	{
		NSAssert(NO, @"Invalid value for GCDAsyncSocketSSLDiffieHellmanParameters1. Value must be of type NSData.");
		
		[self closeWithError:[self otherError:@"Invalid value for GCDAsyncSocketSSLDiffieHellmanParameters1."]];
		return;
	}
	#endif
	...
	if (value)
	{
		NSAssert(NO, @"Security option unavailable - kCFStreamSSLLevel"
		             @" - You must use GCDAsyncSocketSSLProtocolVersionMin1 & GCDAsyncSocketSSLProtocolVersionMax1");
	...
	sslPreBuffer = [[GCDAsyncSocketPreBuffer1 alloc] initWithCapacity:(1024 * 4)];
...
- (void)ssl_continueSSLHandshake
{
	...
	else if (status == errSSLPeerAuthCompleted)
	{
		...
		else
		{
			...
			NSString *msg = @"GCDAsyncSocketManuallyEvaluateTrust1 specified in tlsSettings,"
...
- (void)cf_startTLS
{
	...
	NSAssert([currentRead isKindOfClass:[GCDAsyncSpecialPacket1 class]], @"Invalid read packet for startTLS");
	NSAssert([currentWrite isKindOfClass:[GCDAsyncSpecialPacket1 class]], @"Invalid write packet for startTLS");
...
{
	[[NSThread currentThread] setName:GCDAsyncSocketThreadName1];
...
+ (void)scheduleCFStreams:(GCDAsyncSocket1 *)asyncSocket
{
	LogTrace();
...
+ (void)unscheduleCFStreams:(GCDAsyncSocket1 *)asyncSocket
{
	LogTrace();
	NSAssert([NSThread currentThread] == cfstreamThread, @"Invoked on wrong thread");
...
{
	GCDAsyncSocket1 *asyncSocket = (__bridge GCDAsyncSocket1 *)pInfo;
